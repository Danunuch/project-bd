			...
			<div class="container-xxl">
					...
					<?php foreach ($row_blog as $row_blog) { ?>
						...
						<div class="col-md-6 col-lg-4">
							<a href="blog-detail?blog=<?php echo $row_blog['id']; ?><?php if(isset($_GET['lang'])){$dt=$_GET['lang']; if($dt =="en"){echo "&lang=en";}
								...
								<div class="blog-img">
									<img class="las-img" width="458px" height="312px" src="webpanelcw/assets/blog_upload/<?php if($row_blog['blog_img1'] == null){echo 'upload_icon.png';}else{echo $row_blog["blog_img1"];} ?>" alt="Monarch, khao-tao">
								</div>
								<div class="blog-text" style="height: 330px;">
				...
				<ul class="pagination justify-content-center mt-5">
					<li <?php if ($page == 1) {
						...
						<a class="page-link previous-page" href="blog?page=<?= $page - 1 ?>" aria-disabled="true"><span class="material-icons">keyboard_double_arrow_left</span><?php if ($_GET['lang'] == "en") {
																																														echo "Previous";
																																													} else {
																																														echo "ก่อนหน้า";
																																													} ?></a>
					...
					for ($i = 1; $i <= $total_page; $i++) { ?>
						<li <?php if ($page == $i) {
							...
							} ?>><a class="page-link" href="blog?page=<?= $i ?><?php if (isset($_GET['lang'])) {
								$la = $_GET['lang'];
								if ($la == "en") {
									echo "&lang=en";
								}
					...
					<li <?php if ($page == $total_page) {
						...
						<a class="page-link nextpage" href="blog?page=<?= $page + 1 ?>
