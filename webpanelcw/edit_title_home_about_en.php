...
if (isset($_POST['edit-about-submit'])) {
    ...
    $edit = $conn->prepare("UPDATE home_about_en SET title = :title WHERE id = :id");
...
<div class="layout-container" style="position: absolute; top: 80px; z-index: 1;">
    ...
    <div class="layout-pages">
        <div class="box-title">
            <p class="add-blog">แก้ไขหน้าหลัก (ภาษาอังกฤษ)</p>
        </div>
        <?php
        if (isset($errorMsg)) { ?>
        ...
        <div class="box-form">
            <form method="post" class="form-lo" enctype="multipart/form-data">
                ...
                <textarea name="title" class="form-control" id="title"><?= $row_home["title"] ?></textarea>
