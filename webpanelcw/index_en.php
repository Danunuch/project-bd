    ...
    <div class="layout-pages">
        <div class="box-title">
            ...
            <div class="box-add-home">
                <a href="index"><button class="btn-home-th">เพิ่มข้อมูลฉบับภาษาไทย</button></a>
            </div>
        </div>
        <div class="title-box">
            <?php
            for ($i = 0; $i < count($row_home); $i++) {
                ...
                <h4><?php echo $row_home[$i]['title'] ?> <a href="edit_title_home_en?topic_id=<?php echo $row_home[$i]["id"] ?>"><?php if ($row_home[$i]["title"] == null) {
                                                                                                                                                    echo "";
                                                                                                                                                } else {
                                                                                                                                                    echo "แก้ไขที่นี่";
                                                                                                                                                } ?></a></h4>
                <p><?php echo $row_home[$i]['topic'] . "   " ?><a href="edit_home_en?topic_id=<?php echo $row_home[$i]["id"] ?>"><button class="btn btn-warning"><i class="bi bi-pencil-square"></i></button></a></p>
        ...
        <?php
            for ($i = 0; $i < count($row_home_about); $i++) {
                ...
                <h4><?php echo $row_home_about[$i]['title'] ?> <a href="edit_title_home_about_en?topic_id=<?php echo $row_home_about[$i]["id"] ?>"><?php if ($row_home_about[$i]["title"] == null) {
                                                                                                                                                        echo "";
                                                                                                                                                    } else {
                                                                                                                                                        echo "แก้ไขที่นี่";
                                                                                                                                                    } ?></a></h4>
                <p><?php echo $row_home_about[$i]['topic'] . "   " ?><a href="edit_home_about_en?topic_id=<?php echo $row_home_about[$i]["id"] ?>"><button class="btn btn-warning"><i class="bi bi-pencil-square"></i></button></a></p>
