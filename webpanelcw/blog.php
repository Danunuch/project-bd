...
if (isset($_GET['delete_blog_id']) && isset($_GET['lang'])) {
    ...
    if ($del == 'en') {
        ...
        if ($delete_blog) {
            ...
            echo "<meta http-equiv='Refresh' content='0.001; url=blog'>";
        }
    } else {
        $delete_blog_id = $_GET['delete_blog_id'];
    ...
    <div class="layout-pages">
        <div class="box-title">
            <div class="box-title-add">
                <p class="add-blog"><?php if($_GET["lang"] == "en"){ echo 'All Blog';}else{ echo 'บทความทั้งหมด';} ?></p>
                <a href="?lang=th"><button class="btn-blog-en">TH</button></a>
                <a href="?lang=en"><button class="btn-blog-en">EN</button></a>
                <a <?php if($_GET["lang"] == "en"){ echo 'href="add_blog_en"';}else{ echo 'href="add_blog"';} ?> ><button class="btn-add-blog"><i class="bi bi-plus"></i> <?php if($_GET["lang"] == "en"){ echo 'Add Blog';}else{ echo 'เพิ่มบทความ';} ?> </button></a>
            </div>
            <div class="box-add-blog">
              
                <!-- <a href="add_blog_en"><button class="btn-add-blog">เพิ่มบทความ (ภาษาอังกฤษ)</button></a> -->
            ...
            <table class="table">
                ...
                <tbody> <?php
                        ...
                        if (!$row_blog) {
                            ...
                            <tr align="center">
                                <!-- <th scope="row"><?= $i  ?></th> -->
                                <td><img width="80px" src="assets/blog_upload/<?php if($row_blog['blog_img1'] == null){echo 'upload_icon.png';}else{echo $row_blog["blog_img1"];} ?>" alt=""></td>
        ...
        <ul class="pagination justify-content-center mt-5">
            <li <?php if ($page == 1) {
                ...
                <a class="page-link previous-page" href="blog?page=<?= $page - 1 ?><?php if ($lang == "en") {
                                                                                            echo "&lang=en";
                                                                                        } else {
                                                                                            echo "";
            ...
            for ($i = 1; $i <= $total_page; $i++) { ?>
                <li <?php if ($page == $i) {
                    ...
                    } ?>><a class="page-link" href="blog?page=<?= $i ?><?php if ($lang == "en") {
                                                                                echo "&lang=en";
                                                                            } else {
                                                                                echo "";
                                                                            } ?>"><?= $i ?></a></li>
            ...
            <li <?php if ($page == $total_page) {
                ...
                <a class="page-link nextpage" href="blog?page=<?= $page + 1 ?><?php if ($lang == "en") {
                                                                                        echo "&lang=en";
                                                                                    } else {
                                                                                        echo "";
                                                                                    } ?>">ถัดไป </a>
